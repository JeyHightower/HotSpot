...
const SpotDetail = () => {
  ...
  const userCanReview = sessionUser && 
    spot && 
        ...
        <>
          ...
          <div className="spot-info">
            ...
            <div className="spot-rules">
              <h2>House Rules:</h2>
              <ul>
                {spot.rules && spot.rules.map((rule, index) => (
            ...
            {sortedReviews.length > 0 ? (
              ...
              userCanReview ? (
                <div>
                  ...
                  {showReviewForm && (
                    <CreateReviewForm spotId={spotId} onReviewCreated={handleReviewCreated} />
                  )}
                </div>
              ) : (
                <p>No reviews yet</p>
          ...
          {sessionUser && sessionUser.id === spot.Owner.id && (
            <div className="owner-actions">
              ...
              {showEditForm && (
                <EditSpotForm spot={spot} onClose={() => setShowEditForm(false)} />
              )}
            </div>
          )}
        </>
